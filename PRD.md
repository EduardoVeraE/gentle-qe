...
|---------------|-------------|-------------------|
| **Gentleman Mode** | "Your own Gentleman!" — The Senior Architect mentor who teaches, challenges, and pushes you to understand concepts before code. For Spanish input it mirrors the user's register (neutral Latin American Spanish fallback), direct English otherwise. Uses Tony Stark/Jarvis analogies. | Full persona in CLAUDE.md / opencode agents / .cursorrules, custom thinking verbs, teaching-first behavior |
...
| Thinking verbs | Custom spinner text — Spanish phrases like "Tomando un Cafecito mientras Pienso" (only with Gentleman persona) |
...
- R-CONFIG-07: Thinking verbs and persona-flavored Spanish expressions MUST only be configured when Gentleman persona is selected
...
curl -sL get.gentleman.ai/ai | sh
     ...
     │     The mentor who pushes you     │     challenges, mirrors your Spanish
