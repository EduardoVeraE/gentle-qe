...
description: "Trigger: Playwright a11y, axe-core, WCAG 2.1 AA, keyboard nav, focus, ARIA, screen reader. Automated accessibility testing in TypeScript."
---
...
| [WCAG by Persona & Pattern](./references/wcag-by-persona-and-pattern.md) | WCAG criteria organized by disability persona and UI pattern |
