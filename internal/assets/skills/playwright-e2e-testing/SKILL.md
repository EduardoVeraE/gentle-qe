...
description: "Trigger: Playwright E2E suites, Page Object Model, fixtures, network interception, TypeScript UI flows. Author and maintain E2E test suites."
---
...
| [Testing Anti-Patterns](./references/testing-anti-patterns.md) | Common mistakes to avoid          |
| [CI/CD Pipeline](./references/cicd-pipeline.md)          | Test tiers, tagging & GitHub Actions   |
